...
#import "BreakModel.h"
@interface ConmunicationBreakdownViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation ConmunicationBreakdownViewController
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"alarmType":@"3",@"handleType":@"3",@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"proCode":self.procode};
