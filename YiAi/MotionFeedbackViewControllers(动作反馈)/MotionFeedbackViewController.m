...
#import "BreakModel.h"
@interface MotionFeedbackViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation MotionFeedbackViewController
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"alarmType":@"5",@"handleType":@"3",@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"proCode":self.procode};
