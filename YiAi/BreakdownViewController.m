...
#import "BreakModel.h"
@interface BreakdownViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"alarmType":@"2",@"handleType":@"3",@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"proCode":_procode};
