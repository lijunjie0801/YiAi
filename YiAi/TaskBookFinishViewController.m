//
//  TaskBookFinishViewController.m
//  YiAi
//
...
@interface TaskBookFinishViewController ()<UITableViewDataSource, UITableViewDelegate>

@property(nonatomic, strong) UITableView *tableView;

@end

@implementation TaskBookFinishViewController
