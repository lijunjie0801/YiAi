...
@interface DistortFireViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation DistortFireViewController
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"alarmType":@"1",@"handleType":@"2",@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"proCode":self.procode};
