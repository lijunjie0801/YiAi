...
#import "XFModel.h"
@interface DaiJiViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation DaiJiViewController
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"projectId":self.procode,@"deviceType":self.myTitle,@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"smokeControlType":@"屏蔽"};
