//
//  VideoEscapeRouteViewController.m
//  YiAi
//
...
@interface VideoEscapeRouteViewController ()<UITableViewDataSource, UITableViewDelegate>

@property(nonatomic, strong) UITableView *tableView;

@end

@implementation VideoEscapeRouteViewController
