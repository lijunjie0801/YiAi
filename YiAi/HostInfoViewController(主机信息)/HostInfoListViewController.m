//
//  HostInfoListViewController.m
//  YiAi
//
//  Created by lijunjie on 2017/7/24.
//  Copyright © 2017年 zlkj. All rights reserved.
//

#import "HostInfoListViewController.h"

@interface HostInfoListViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableview;
@property(nonatomic,strong)NSString *procode;
@property(nonatomic,strong)NSArray *hostList;
@end

@implementation HostInfoListViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [_svc pushViewController:_svc.HostDetailViewController withObjects:@{@"procode":procode,@"hostId":hostId,@"isEdit":@"1"}];
}
