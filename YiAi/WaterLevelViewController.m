...
@interface WaterLevelViewController ()<UITableViewDataSource, UITableViewDelegate>
...
-(void)headerRefresh
{
    ...
    NSDictionary *param = @{@"appKey":[AppDataManager defaultManager].identifier,@"dataType":@"2",@"page":[NSString stringWithFormat:@"%d",pageNum],@"pageSize":@10,@"proCode":self.procode};
