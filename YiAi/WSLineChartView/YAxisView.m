...
- (id)initWithFrame:(CGRect)frame yMax:(CGFloat)yMax yMin:(CGFloat)yMin {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor =[UIColor clearColor]; //[UIColor colorWithRed:85.0f/255.0f green:85.0f/255.0f blue:85.0f/255.0f alpha:1.0f];
        self.yMax = yMax;
        self.yMin = yMin;
...
- (void)drawRect:(CGRect)rect {
    ...
    [self drawLine:context startPoint:CGPointMake(self.frame.size.width-1, 0) endPoint:CGPointMake(self.frame.size.width-1, self.frame.size.height - labelSize.height - xAxisTextGap) lineColor:[UIColor whiteColor] lineWidth:1];
